          ...
          <div className="lg:col-span-2">
            ...
            <div className="flex items-center gap-3">
              {props.socialLinks.map((s, i) => (
                <a key={i} href={safeUrl(s.url)} target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-white/5 hover:bg-rose-500 flex items-center justify-center text-gray-400 hover:text-white transition-all duration-300">
